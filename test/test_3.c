...
int main(int argc, char* argv[])
{
	...
	if(argc == 2)
	{
		...
		if(0 < annee_voulue)
		{
			...
			horaire_de_passage_a_l_heure_d_hiver_pour_la_base_antarctique_de_troll_sous_forme_de_timestamp = date_du_dernier_dimanche_d_octobre(timestamp_courant_avec_annee_voulue, 3);

			/* Nouvelle-Zélande et Base antarctique de McMurdo */
			horaire_de_passage_a_l_heure_d_ete_pour_la_nouvelle_zelande_et_la_base_antarctique_de_mcmurdo_sous_forme_de_timestamp = date_du_dernier_dimanche_de_septembre(timestamp_courant_avec_annee_voulue, 2);
