...
void fonction_pour_l_affichage_des_changements_d_heures(int nombre_d_arguments_passes_en_parametre, char* liste_des_arguments_passes_en_parametre[])
{
	...
	if(0 < annee_voulue)
	{
		...
		horaire_de_passage_a_l_heure_d_hiver_pour_le_bresil_sous_forme_de_timestamp = date_du_n_ieme_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 3, 3, 0, 1);

		/* République arabe syrienne */
		horaire_de_passage_a_l_heure_d_ete_pour_la_syrie_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 2, 5, 2);
		horaire_de_passage_a_l_heure_d_hiver_pour_la_syrie_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 3, 5, 9);

		/* État d'Israël */
		horaire_de_passage_a_l_heure_d_ete_pour_l_etat_d_israel_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 2, 5, 2);
		horaire_de_passage_a_l_heure_d_hiver_pour_l_etat_d_israel_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 3, 0, 9);

		/* État de Palestine */
		horaire_de_passage_a_l_heure_d_ete_pour_la_palestine_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 1, 6, 2);
		horaire_de_passage_a_l_heure_d_hiver_pour_la_palestine_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 1, 6, 9);

		/* République libanaise */
		horaire_de_passage_a_l_heure_d_ete_pour_le_liban_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 2, 0, 2);
		horaire_de_passage_a_l_heure_d_hiver_pour_le_liban_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 3, 0, 9);
		...
		horaire_de_passage_a_l_heure_d_hiver_pour_la_jordanie_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 3, 5, 9);
		...
		horaire_de_passage_a_l_heure_d_hiver_pour_le_paraguay_sous_forme_de_timestamp = date_du_n_ieme_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 4, 0, 0, 2);

		/* Base antarctique de Troll */
		horaire_de_passage_a_l_heure_d_ete_pour_la_base_antarctique_de_troll_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 1, 0, 2);
		horaire_de_passage_a_l_heure_d_hiver_pour_la_base_antarctique_de_troll_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 3, 0, 9);

		/* Nouvelle-Zélande et Base antarctique de McMurdo */
		horaire_de_passage_a_l_heure_d_ete_pour_la_nouvelle_zelande_et_la_base_antarctique_de_mcmurdo_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 2, 0, 8);
		...
		horaire_de_passage_a_l_heure_d_ete_pour_les_samoa_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 4, 0, 8);
		...
		/* Europe continentale */
		horaire_de_passage_a_l_heure_d_ete_pour_l_europe_continentale_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 3, 0, 2);
		horaire_de_passage_a_l_heure_d_hiver_pour_l_europe_continentale_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 2, 0, 9);

		/* Royaume-Uni de Grande-Bretagne et d'Irlande du Nord */
		horaire_de_passage_a_l_heure_d_ete_pour_la_grande_bretagne_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 1, 0, 2);
		horaire_de_passage_a_l_heure_d_hiver_pour_la_grande_bretagne_sous_forme_de_timestamp = date_du_dernier_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 2, 0, 9);

		/* Amérique du Nord */
		horaire_de_passage_a_l_heure_d_ete_pour_l_amerique_du_nord_sous_forme_de_timestamp = date_du_n_ieme_jour_de_la_semaine_donne_du_mois_donne(timestamp_courant_avec_annee_voulue, 2, 2, 0, 2);
